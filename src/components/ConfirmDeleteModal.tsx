...
export default function ConfirmDeleteModal({ complaint, count, onClose, onConfirm }: Props) {
  const [deleting, setDeleting] = useState(false);
  const isBulk = !complaint && !!count;
    ...
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal" style={{ maxWidth: 440 }}>
        <div className="modal-header">
          <div className="modal-title">{isBulk ? "Delete Complaints" : "Delete Complaint"}</div>
